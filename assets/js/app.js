...
function about() {
    if (handleCurrentPage(currentPage, ABOUT_PAGE_FLAG, document)) {
        ...
        renderAboutMe(fullTimeStartDate, javaStartDate, ReactStartDate, javaScriptStartDate, NodejsStartDate,
            gitStartDate, gitHubStartDate, mongoDBStartDate, dsaStartDate, webDevelopmentStartDate);
