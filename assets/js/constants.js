...
const javaStartDate = new Date(2021, 1, 1);
const ReactStartDate = new Date(2022, 7, 1);
const javaScriptStartDate = new Date(2021, 4, 1);
const NodejsStartDate = new Date(2022, 7, 1);
const gitStartDate = new Date(2022, 7, 1);
const gitHubStartDate = new Date(2022, 7, 1);
const mongoDBStartDate = new Date(2022, 7, 1);
const webDevelopmentStartDate = new Date(2020, 9, 1);
const dsaStartDate = new Date(2022, 7, 1);