...
function renderAboutMe(
    ...
    /* React */
    let springTimeElapsedTime = Date.now() - ReactStartDate.getTime();
    ...
    /* Nodejs */
    let angularElapsedTime = Date.now() - NodejsStartDate.getTime();
    ...
    /* Git */
    let azureElapsedTime = Date.now() - gitStartDate.getTime();
    ...
    /* Gihub*/
    let kubElapsedTime = Date.now() - gitHubStartDate.getTime();
    ...
    /* MoondgoDb*/
    let microServicesElapsedTime = Date.now() - mongoDBStartDate.getTime();
    ...
    /* DSA */
    let restApisElapsedTime = Date.now() - dsaStartDate.getTime();
